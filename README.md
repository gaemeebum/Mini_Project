...
|--------|---------|---------------------|--------|
| บรรลุวัตถุประสงค์กลุ่ม | 30% | 10  | ทำฟีเจอร์ครบทั้งหมดตามที่ออกแบบไว้ ทั้งดูรายชื่อห้อง จองห้อง ดูรายการจอง ยกเลิกจอง และค้นหาการจอง ระบบทำงานตรงตาม concept ที่ตั้งใจไว้ทุกจุด |
| ความสอดคล้องของเนื้อหาและมาตรฐานของงาน | 30% | 10 | เลือกใช้โครงสร้างข้อมูลเหมาะสมตาม LO1 (tuple สำหรับ `ROOMS` ที่ไม่เปลี่ยนแปลง, list of dict สำหรับ `bookings` ที่ต้องแก้ไขได้) ใช้ enumerate และ list comprehension ตรงตาม LO2 มีคอมเมนต์อธิบายโค้ดชัดเจนทุกฟังก์ชัน |
| ปริมาณ คุณภาพ และธรรมาภิบาลของงาน | 30% | 10 | โค้ดมี defensive programming ครบทุกฟังก์ชัน (ตรวจห้องมีจริง ตรวจจองซ้ำวัน/เวลา ตรวจ `isdigit()` ก่อนยกเลิกจอง) และมีการบันทึก learning log พร้อมทดสอบ edge case ครอบคลุม  |
| ภาพรวมงานกลุ่มทั้งหมด | 10% | 10 | งานเสร็จตรงเวลาทุก Task สมาชิกทำงานร่วมกันตามหน้าที่ที่แบ่งไว้ชัดเจน (Planner/Coder/Debugger) และมีการสื่อสารประสานงานกันอย่างต่อเนื่อง |
| **รวม (ถ่วงน้ำหนัก)** | **100%** | **10 / 10** | |
...
## 🔗 Project Artifacts
- Source code: https://github.com/gaemeebum/Mini_Project/blob/d0e28d1d843f018aee041a43e3febe881f5327a6/Sourcecode.ipynb
